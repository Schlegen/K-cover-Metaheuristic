...
data_list=("data/captANOR900_14_20_2021.dat")
...
do  
    for k in 1 2; do
        for R in "2 2" "2 3"; do
            ...
            echo $file $1 $2 $k
            py main.py -m "localsearch" -d $file -rcapt $1 -rcom $2 -k $k -s "saves/scores_benchmark_maxime.csv" -t 600 --optim> "logs/logs_ls/${log_name}_$1_$2_$k.txt"
            py main.py -m "genetic" -d $file -rcapt $1 -rcom $2 -k $k -s "saves/scores_benchmark_maxime.csv" -t 600 --optim> "logs/logs_genetic/${log_name}_$1_$2_$k.txt"
        done
    done
done